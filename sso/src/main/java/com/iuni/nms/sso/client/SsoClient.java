package com.iuni.nms.sso.client;

import com.google.common.collect.Maps;
import com.iuni.nms.sso.constants.SsoConstant;
import com.iuni.nms.sso.dto.SsoGetMenuResult;
import com.iuni.nms.sso.dto.SsoLoginCheckResult;
import com.iuni.nms.sso.dto.SsoValidateTicketResult;
import com.iuni.nms.sso.utils.JsonUtil;
...
//		String url = SsoConstant.UUC_URL + SsoConstant.UUC_FETCH_MENU_URI;
		String url = ssoConstant.getUUC_URL() + SsoConstant.UUC_FETCH_MENU_URI;
...
//		String url = SsoConstant.UUC_URL + SsoConstant.UUC_AUTHC_VALIDATE_URI;
		String url = ssoConstant.getUUC_URL() + SsoConstant.UUC_AUTHC_VALIDATE_URI;
		HttpPost httpPost = new HttpPost(url);
...
//		String url = SsoConstant.UUC_URL + SsoConstant.UUC_AUTHZ_CHECK_URI;
		String url = ssoConstant.getUUC_URL() + SsoConstant.UUC_AUTHZ_CHECK_URI;
		HttpPost httpPost = new HttpPost(url);
...
//		headMap.put("appid", SsoConstant.UUC_APP_NMS_ID);
		headMap.put("appid", ssoConstant.getUUC_APP_NMS_ID());
		String timeStr = String.valueOf(System.currentTimeMillis());
		headMap.put("ttl", timeStr);
//		headMap.put("validcode", DigestUtils.md5Hex(jsonUtils.toJson(bodyMap) + SsoConstant.UUC_APP_NMS_KEY + timeStr));
		headMap.put("validcode", DigestUtils.md5Hex(jsonUtils.toJson(bodyMap) + ssoConstant.getUUC_APP_NMS_KEY() + timeStr));
		// 整个内容信息
