                ...
                <div class="col-xs-12">
                    <div class="portlet box grey">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>监控对象类型列表
                            </div>
                        </div>
                        <!-- /.box-header -->
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <button id="table_monitorObjectType_new" class="btn green">
                                                添加 <i class="fa fa-plus"></i>
                                            </button>
                                            <button id="table_monitorObjectType_delete" class="btn red">
                                    ...
                                    <%--<div class="col-md-6">--%>
                                        <%--<div class="btn-group pull-right">--%>
                                            <%--<button id="table_monitorObjectType_export" class="btn yellow">--%>
                            ...
                            <table id="table_monitorObjectType" class="table table-striped table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th class="table-checkbox"><input type="checkbox" class="group-checkable"
                                                                      data-set="#table_monitorObjectType .checkboxes"/></th>
                                    <th>监控对象类型名称</th>
                                    <th>备 注</th>
                                    <th>创建日期</th>
                                    <th>操 作</th>
                                ...
                                <tbody>
                                <c:forEach items="${monitorObjectTypeList}" var="monitorObjectType">
                                    <tr class="odd gradeX">
                                        <td><input type="checkbox" class="checkboxes" value="${monitorObjectType.id}"/></td>
                                        <td>${monitorObjectType.name}</td>
                                        <td>${monitorObjectType.desc}</td>
                                        <td>${monitorObjectType.createDate}</td>
                                        <td>
                                            <a class="edit text-blue" id="edit_${monitorObjectType.id}" href="javascript:;"><i
                                                    class="fa fa-pencil text-blue"></i> 编辑 </a>
                                            |
                                            <%--<c:if test="${monitorObjectType.status == 1}">--%>
                                                <%--<a class="disable text-yellow" id="disable_${monitorObjectType.id}" href="javascript:;"><i--%>
                                                        <%--class="fa fa-stop text-yellow"></i> 禁用 </a>--%>
                                            <%--</c:if>--%>
                                            <%--<c:if test="${monitorObjectType.status == 0}">--%>
                                                <%--<a class="enable text-green" id="enable_${monitorObjectType.id}" href="javascript:;"><i--%>
                                                        <%--class="fa fa-play text-green"></i> 启用 </a>--%>
                                            <%--</c:if>--%>
                                            <%--|--%>
                                            <a class="delete text-red" id="delete_${monitorObjectType.id}" href="javascript:;"><i
...
<script src="/resources/scripts/config/monitorObjectType.js" type="text/javascript"></script>

<script>
    jQuery(document).ready(function () {
        MonitorObjectTypeTable.init();
    });
</script>
