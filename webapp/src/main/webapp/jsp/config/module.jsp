                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <button id="table_module_new" class="btn green">
                                                添加 <i class="fa fa-plus"></i>
                                            </button>
                                            <button id="table_module_delete" class="btn red">
                                    ...
                                    <%--<div class="col-md-6">--%>
                                        <%--<div class="btn-group pull-right">--%>
                                            <%--<button id="table_module_export" class="btn yellow">--%>
                            ...
                            <table id="table_module" class="table table-striped table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th class="table-checkbox"><input type="checkbox" class="group-checkable"
                                                                      data-set="#table_module .checkboxes"/></th>
                                    <th>模块编码</th>
                                    <th>模块名称</th>
                                    <th>所属系统</th>
                                    <th>创建日期</th>
                                ...
                                <c:forEach items="${modules}" var="module">
                                    <tr class="odd gradeX">
                                        <td><input type="checkbox" class="checkboxes" value="${module.id}"/></td>
                                        <td>${module.code}</td>
                                        <td>${module.name}</td>
                                        <td>${module.system.name}</td>
                                        <td>${module.createDate}</td>
                                        <td>${module.desc}</td>
                                        <td>
                                            <a class="edit text-blue" id="edit_${module.id}" href="javascript:;"><i
                                                    class="fa fa-pencil text-blue"></i> 编辑 </a>
                                            |
                                            <%--<c:if test="${module.status == 1}">--%>
                                                <%--<a class="disable text-yellow" id="disable_${module.id}" href="javascript:;"><i--%>
                                                        <%--class="fa fa-stop text-yellow"></i> 禁用 </a>--%>
                                            <%--</c:if>--%>
                                            <%--<c:if test="${module.status == 0}">--%>
                                                <%--<a class="enable text-green" id="enable_${module.id}" href="javascript:;"><i--%>
                                                        <%--class="fa fa-play text-green"></i> 启用 </a>--%>
                                            <%--</c:if>--%>
                                            <%--|--%>
                                            <a class="delete text-red" id="delete_${module.id}" href="javascript:;"><i
