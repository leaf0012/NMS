                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form:form id="form_alarmGroup" class="form-horizontal" action="/config/alarmGroup/save"
                                       method="post"
                                       modelAttribute="alarmGroup">
                                <div class="form-body">
                                    ...
                                    <form:input type="hidden" id="alarmGroup-id" name="id" value="${alarmGroup.id}"
                                                path="id"/>

                                    <div class="form-group">
                                        <name class="control-label col-md-3">告警组名称 <span class="required">
										* </span>
                                        </name>

                                        <div class="col-md-4">
                                            <form:input type="text" name="name" value="${alarmGroup.name}"
                                                        data-required="1"
                                                        class="form-control"
                                                        path="name"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <name class="control-label col-md-3">选择告警人 <span class="required">
										* </span>
                                        </name>

                                        <div class="col-md-4">
                                            <form:select id="selectAlarmPersons"
                                                         class="form-control select2"
                                                         multiple="multiple"
                                                         data-placeholder="请选择选择告警人，至少选择一个"
                                                         value="${alarmGroup.alarmPersons}" path="alarmPersons">
                                                <form:options items="${alarmPersons}" itemValue="id" itemLabel="name"/>
                                            </form:select>
                                        </div>
                                    </div>
                                    <div class="form-group">
										...
										* </span>
                                        ...
                                        <div class="col-md-4">
                                            <form:select id="selectMonitorItems"
                                                ...
                                                <form:options items="${monitorItems}" itemValue="id" itemLabel="name"/>
                                            </form:select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button id="cancel_form_alarmGroup" type="button" class="btn default">取消
                                            </button>
                                        </div>
                                    </div>
                                </div>
