                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form:form id="form_monitorItem" class="form-horizontal" action="/config/monitorItem/save"
                                       method="post"
                                       modelAttribute="monitorItem">
                                <div class="form-body">
                                    ...
                                    <form:input type="hidden" id="monitorItem-id" name="id" value="${monitorItem.id}"
                                                path="id"/>
                                    <div class="form-group">
                                        <name class="control-label col-md-3">监控项名称 <span class="required">
										* </span>
                                        </name>

                                        <div class="col-md-4">
                                            <form:input type="text" name="name" value="${monitorItem.name}"
                                                        data-required="1"
                                                        class="form-control"
                                                        path="name"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <name class="control-label col-md-3">监控项编码 <span class="required">
										* </span>
                                        </name>

                                        <div class="col-md-4">
                                            <form:input type="text" name="code" value="${monitorItem.code}"
                                                        data-required="1"
                                                        class="form-control"
                                                        path="code"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <name class="control-label col-md-3">监控项类型<span class="required">
										* </span>
                                        </name>

                                        <div class="col-md-4">
                                            <form:select class="form-control select2me" id="monitorItemTypeId"
                                                         name="monitorItemType.id" value="${monitorItem.monitorItemType.id}"
                                                         path="monitorItemType.id"
                                                         items="${monitorItemTypes}" itemLabel="name" itemValue="id"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <form:input name="desc" value="${monitorItem.desc}" type="text"
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button id="cancel_form_monitorItem" type="button" class="btn default">取消
                                            </button>
                                        </div>
                                    </div>
                                </div>
...
<script>
    jQuery(document).ready(function () {
        MonitorItemFormValidation.init();
    });
</script>
</body>
</html>
