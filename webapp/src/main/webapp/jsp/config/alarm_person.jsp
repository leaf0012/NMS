...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <i class="fa fa-dashboard"></i> Home > 系统配置 > 告警人员管理 >
                <small>告警人列表</small>
            </h1>
        </section>
                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <button id="table_alarmPerson_new" class="btn green">
                                                添加 <i class="fa fa-plus"></i>
                                            </button>
                                            <button id="table_alarmPerson_delete" class="btn red">
                                    ...
                                    <%--<div class="col-md-6">--%>
                                        <%--<div class="btn-group pull-right">--%>
                                            <%--<button id="table_alarmPerson_export" class="btn yellow">--%>
                            ...
                            <table id="table_alarmPerson" class="table table-striped table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th class="table-checkbox"><input type="checkbox" class="group-checkable"
                                                                      data-set="#table_alarmPerson .checkboxes"/></th>
                                    <th>姓名</th>
                                    <th>电话</th>
                                    <th>邮箱</th>
                                    <th>创建日期</th>
                                ...
                                <tbody>
                                <c:forEach items="${alarmPersonList}" var="alarmPerson">
                                    <tr class="odd gradeX">
                                        <td><input type="checkbox" class="checkboxes" value="${alarmPerson.id}"/></td>
                                        <td>${alarmPerson.name}</td>
                                        <td>${alarmPerson.mobile}</td>
                                        <td>${alarmPerson.email}</td>
                                        <td>${alarmPerson.createDate}</td>
                                        <td>
                                            <a class="edit text-blue" id="edit_${alarmPerson.id}" href="javascript:;"><i
                                                    class="fa fa-pencil text-blue"></i> 编辑 </a>
                                            |
                                            <%--<c:if test="${alarmPerson.status == 1}">--%>
                                                <%--<a class="disable text-yellow" id="disable_${alarmPerson.id}" href="javascript:;"><i--%>
                                                        <%--class="fa fa-stop text-yellow"></i> 禁用 </a>--%>
                                            <%--</c:if>--%>
                                            <%--<c:if test="${alarmPerson.status == 0}">--%>
                                                <%--<a class="enable text-green" id="enable_${alarmPerson.id}" href="javascript:;"><i--%>
                                                        <%--class="fa fa-play text-green"></i> 启用 </a>--%>
                                            <%--</c:if>--%>
                                            <%--|--%>
                                            <a class="delete text-red" id="delete_${alarmPerson.id}" href="javascript:;"><i
...
<script src="/resources/scripts/config/alarmPerson.js" type="text/javascript"></script>

<script>
    jQuery(document).ready(function () {
        AlarmPersonTable.init();
    });
</script>
