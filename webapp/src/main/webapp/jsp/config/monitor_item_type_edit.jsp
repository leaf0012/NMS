                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form:form id="form_monitorItemType" class="form-horizontal" action="/config/monitorItemType/save"
                                       method="post"
                                       modelAttribute="monitorItemType">
                                <div class="form-body">
                                    ...
                                    <form:input type="hidden" id="monitorItemType-id" name="id" value="${monitorItemType.id}"
                                                path="id"/>

                                    <div class="form-group">
                                        <name class="control-label col-md-3">监控项类型名称 <span class="required">
										* </span>
                                        </name>

                                        <div class="col-md-4">
                                            <form:input type="text" name="name" value="${monitorItemType.name}"
                                                        data-required="1"
                                                        class="form-control"
                                                        path="name"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <form:input name="desc" value="${monitorItemType.desc}" type="text"
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button id="cancel_form_monitorItemType" type="button" class="btn default">取消
                                            </button>
                                        </div>
                                    </div>
                                </div>
...
<script>
    jQuery(document).ready(function () {
        MonitorItemTypeFormValidation.init();
    });
</script>
</body>
</html>
