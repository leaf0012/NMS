                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form:form id="form_alarmPerson" class="form-horizontal" action="/config/alarmPerson/save"
                                       method="post"
                                       modelAttribute="alarmPerson">
                                <div class="form-body">
                                    ...
                                    <form:input type="hidden" id="alarmPerson-id" name="id" value="${alarmPerson.id}"
                                                path="id"/>

                                    <div class="form-group">
                                        <name class="control-label col-md-3">告警人名称 <span class="required">
										* </span>
                                        </name>

                                        <div class="col-md-4">
                                            <form:input type="text" name="name" value="${alarmPerson.name}"
                                                        data-required="1"
                                                        class="form-control"
                                                        path="name"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <name class="control-label col-md-3">告警人电话 <span class="required">
										* </span>
                                        </name>

                                        <div class="col-md-4">
                                            <form:input type="text" name="mobile" value="${alarmPerson.mobile}"
                                                        data-required="1"
                                                        class="form-control"
                                                        path="mobile"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <name class="control-label col-md-3">告警人邮箱 <span class="required">
										* </span>
                                        </name>

                                        <div class="col-md-4">
                                            <form:input type="text" name="email" value="${alarmPerson.email}"
                                                        data-required="1"
                                                        class="form-control"
                                                        path="email"/>
                                        </div>
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button id="cancel_form_alarmPerson" type="button" class="btn default">取消
                                            </button>
                                        </div>
                                    </div>
                                </div>
...
<script>
    jQuery(document).ready(function () {
        AlarmPersonFormValidation.init();
    });
</script>
</body>
</html>
