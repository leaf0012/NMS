...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <i class="fa fa-dashboard"></i> Home > 系统配置 > 监控项管理 > 监控项属性定义 >
                <small> ${monitorItemProps.monitorItem.name} </small>
            </h1>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form:form id="form_monitorItemProps" class="form-horizontal" action="/config/monitorItemProps/save"
                                       method="post"
                                       modelAttribute="monitorItemProps">
                                <div class="form-body">
                                    ...
                                    <form:input type="hidden" id="monitorItemProps-id" name="id" value="${monitorItemProps.id}"
                                                path="id"/>
                                    <form:input type="hidden" id="monitorItem-id" name="monitorItemId" value="${monitorItemProps.monitorItem.id}"
                                                path="monitorItem.id"/>
                                    <div class="form-group">
                                        <name class="control-label col-md-3">监控项属性名称 <span class="required">
										* </span>
                                        </name>

                                        <div class="col-md-4">
                                            <form:input type="text" name="name" value="${monitorItemProps.name}"
                                                        data-required="1"
                                                        class="form-control"
                                                        path="name"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <name class="control-label col-md-3">监控项属性编码 <span class="required">
										* </span>
                                        </name>

                                        <div class="col-md-4">
                                            <form:input type="text" name="code" value="${monitorItemProps.code}"
                                                        data-required="1"
                                                        class="form-control"
                                                        path="code"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <name class="control-label col-md-3">监控项级别<span class="required">
										* </span>
                                        </name>

                                        <div class="col-md-4">
                                            <form:select class="form-control select2me" id="level"
                                                         name="level" value="${monitorItemProps.level}"
                                                         path="level"
                                                         items="${monitorItemPropsLevels}" itemLabel="name" itemValue="code"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <name class="control-label col-md-3">告警模板 <span class="required">
										* </span>
                                        </name>

                                        <div class="col-md-4">
                                            <form:input type="text" name="alarmTemplate" value="${monitorItemProps.alarmTemplate}"
                                                        data-required="1"
                                                        class="form-control"
                                                        path="alarmTemplate"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <form:input name="desc" value="${monitorItemProps.desc}" type="text"
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button id="cancel_form_monitorItemProps" type="button" class="btn default">取消
                                            </button>
                                        </div>
                                    </div>
                                </div>
...
<script>
    jQuery(document).ready(function () {
        MonitorItemPropsFormValidation.init();
    });
</script>
</body>
</html>
